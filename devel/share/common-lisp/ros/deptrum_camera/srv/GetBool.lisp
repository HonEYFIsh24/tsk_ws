...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<GetBool-request> is deprecated: use deptrum_camera-srv:GetBool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<GetBool-response> is deprecated: use deptrum_camera-srv:GetBool-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetBool-response>)))
  ...
  "deptrum_camera/GetBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetBool-response)))
  "Returns string type for a service object of type 'GetBool-response"
  "deptrum_camera/GetBoolResponse")
