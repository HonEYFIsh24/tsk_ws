...
(defsystem "deptrum_camera-srv"
  :depends-on (:roslisp-msg-protocol :roslisp-utils :deptrum_camera-msg
               :sensor_msgs-msg
)
  :components ((:file "_package")
    ...
    (:file "GetInt32TwoParam" :depends-on ("_package_GetInt32TwoParam"))
    (:file "_package_GetInt32TwoParam" :depends-on ("_package"))
    ...
    (:file "SetInt32TwoParam" :depends-on ("_package_SetInt32TwoParam"))
    (:file "_package_SetInt32TwoParam" :depends-on ("_package"))
