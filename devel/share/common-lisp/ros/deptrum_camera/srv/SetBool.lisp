...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<SetBool-request> is deprecated: use deptrum_camera-srv:SetBool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<SetBool-response> is deprecated: use deptrum_camera-srv:SetBool-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBool-response>)))
  ...
  "deptrum_camera/SetBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBool-response)))
  "Returns string type for a service object of type 'SetBool-response"
  "deptrum_camera/SetBoolResponse")
