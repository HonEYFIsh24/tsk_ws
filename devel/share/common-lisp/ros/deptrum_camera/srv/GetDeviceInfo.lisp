...
(cl:defmethod cl:initialize-instance :after ((m <GetDeviceInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDeviceInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<GetDeviceInfo-request> is deprecated: use deptrum_camera-srv:GetDeviceInfo-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDeviceInfo-request>)))
  ...
  "deptrum_camera/GetDeviceInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDeviceInfo-request)))
  "Returns string type for a service object of type 'GetDeviceInfo-request"
  "deptrum_camera/GetDeviceInfoRequest")
...
(cl:defclass <GetDeviceInfo-response> (roslisp-msg-protocol:ros-message)
  ((info
    :reader info
    :initarg :info
    :type deptrum_camera-msg:DeviceInfo
    :initform (cl:make-instance 'deptrum_camera-msg:DeviceInfo))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <GetDeviceInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDeviceInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name deptrum_camera-srv:<GetDeviceInfo-response> is deprecated: use deptrum_camera-srv:GetDeviceInfo-response instead.")))

(cl:ensure-generic-function 'info-val :lambda-list '(m))
(cl:defmethod info-val ((m <GetDeviceInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader deptrum_camera-srv:info-val is deprecated.  Use deptrum_camera-srv:info instead.")
  (info m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDeviceInfo-response>)))
  ...
  "deptrum_camera/GetDeviceInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDeviceInfo-response)))
  "Returns string type for a service object of type 'GetDeviceInfo-response"
  "deptrum_camera/GetDeviceInfoResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetDeviceInfo-response>)))
  ...
  (cl:format cl:nil "DeviceInfo info~%bool success~%string message~%~%~%================================================================================~%MSG: deptrum_camera/DeviceInfo~%std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetDeviceInfo-response)))
  "Returns full string definition for message of type 'GetDeviceInfo-response"
  (cl:format cl:nil "DeviceInfo info~%bool success~%string message~%~%~%================================================================================~%MSG: deptrum_camera/DeviceInfo~%std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
