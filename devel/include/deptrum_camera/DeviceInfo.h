// Generated by gencpp from file deptrum_camera/DeviceInfo.msg
// DO NOT EDIT!


#ifndef DEPTRUM_CAMERA_MESSAGE_DEVICEINFO_H
#define DEPTRUM_CAMERA_MESSAGE_DEVICEINFO_H
...
struct DeviceInfo_
{
  ...
  typedef boost::shared_ptr< ::deptrum_camera::DeviceInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::deptrum_camera::DeviceInfo_<ContainerAllocator> const> ConstPtr;

}; // struct DeviceInfo_

typedef ::deptrum_camera::DeviceInfo_<std::allocator<void> > DeviceInfo;

typedef boost::shared_ptr< ::deptrum_camera::DeviceInfo > DeviceInfoPtr;
typedef boost::shared_ptr< ::deptrum_camera::DeviceInfo const> DeviceInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::deptrum_camera::DeviceInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::deptrum_camera::DeviceInfo_<ContainerAllocator1> & lhs, const ::deptrum_camera::DeviceInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::deptrum_camera::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::deptrum_camera::DeviceInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deptrum_camera::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::deptrum_camera::DeviceInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1888569b0132dc80ULL;
  static const uint64_t static_value2 = 0x4ac1aacd640af6e8ULL;
};

template<class ContainerAllocator>
struct DataType< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::deptrum_camera::DeviceInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::deptrum_camera::DeviceInfo_<ContainerAllocator>& v)
  {
...
#endif // DEPTRUM_CAMERA_MESSAGE_DEVICEINFO_H
